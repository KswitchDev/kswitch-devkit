# KSwitch wire-contract schemas - v1.37.1-pg (current)

**Purpose.** This directory holds the pinned request/response schema fixtures
for the current KSwitch server version **v1.37.1-pg**. Together with the
sibling `../v1.37.0/` directory, these fixtures back the per-SDK
...
**Pin reference.**
- Current root `VERSION` file: `1.37.1-pg`
- Current release tag: `v1.37.1-pg`
- Tag commit: `ccaadfd`
...
in the file headers when the fixtures are exported.
