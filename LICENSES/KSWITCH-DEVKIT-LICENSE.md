...
This is a source-available, non-commercial licence. It is not an open-source
licence.
...
- use by or for an employer, company, client, customer, contractor, or managed
  service customer;
- customer-facing use;
- managed-service use;
...
- using KSwitch names, marks, logos, product names, screenshots, or trade dress
  except as permitted by `TRADEMARKS.md`;
- publishing benchmark, comparison, compliance, security, production-readiness,
  or performance claims without written KSwitch permission;
- reverse engineering, decompiling, or extracting binary-only commercial
  runtime internals, hosted-service interfaces, entitlement controls, or cap
  controls, except to the extent such a restriction is unenforceable under
  applicable law.
...
This licence does not grant any right to production deployment, commercial
deployment, hosted service operation, managed service operation, enterprise
support, cloud packages, high availability, fleet operations, SIEM/event-bus
integrations, desktop hard-containment, enterprise enforcement add-ons,
regulated-deployment claims, or commercial runtime features.

## 5. No Trademark Licence

No trademark licence is granted. Nominative use needed to identify KSwitch
software is governed by `TRADEMARKS.md`.
...
KSwitch software or services infringe a patent.
