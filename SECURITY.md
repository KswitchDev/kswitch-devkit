...
Do not open public GitHub issues containing vulnerabilities, exploit details,
secrets, customer data, private URLs, production logs, or sensitive environment
details.
